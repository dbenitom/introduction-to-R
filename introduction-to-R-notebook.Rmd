...
Comments? Interested in microbial growth? Need to improve digestibility!
...
Now take a different substrate:
...
Here's a really simple first bar plot. You can explore the `ggplot2` universe in google to beautify your plot.
